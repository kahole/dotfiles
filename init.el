...
(custom-set-variables
 ...
 '(org-agenda-files (quote ("~/ntnu/todo.org")))
 '(package-selected-packages
   (quote
    (go-mode spacemacs-theme moe-theme solarized-theme evil-commentary magit ace-jump-mode org-bullets org-present exec-path-from-shell company all-the-icons-ivy neotree doom-themes evil markdown-mode)))
